<%@ Page Language="C#" Title="Windows Mobile" AutoEventWireup="true" MasterPageFile="~/Site3.Master" CodeBehind="Windows.aspx.cs" Inherits="Assignment_SportsPro.Windows" %>
    ...
    <div class="container" style="margin: 20px">
        <main>
            <div class="form-group row">
                <div class="col-md-2">
                    <asp:Label ID="lblWindowsBrand" CssClass="customWidth" runat="server" Text="Select Company:"></asp:Label>
                </div>
                <asp:DropDownList ID="ddlwindowsmodel" runat="server" DataSourceID="SqlDataSource1" DataTextField="Model" DataValueField="Desc_Id" AutoPostBack="True"></asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\project.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [Desc_Id], [Product_Id], [Model] FROM [Product_Description] WHERE ([Product_Id] = @Product_Id) ORDER BY [Model]">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="8" Name="Product_Id" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
            <br />
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\project.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [Product_Description] WHERE ([Desc_Id] = @Desc_Id) ORDER BY [Model]">
                <SelectParameters>
                    <asp:ControlParameter ControlID="ddlwindowsmodel" Name="Desc_Id" PropertyName="SelectedValue" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
        </main>
        <br />
