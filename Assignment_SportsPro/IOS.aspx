<%@ Page Title="IOS mobiles" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site3.Master" CodeBehind="IOS.aspx.cs" Inherits="Assignment_SportsPro.IOS" %>
    ...
    <div class="container" style="margin: 20px">
        <main>
            <div class="form-group row">
                <div class="col-md-2">
                    <asp:Label ID="lblIOSBrand" CssClass="customWidth" runat="server" Text="Select Company:"></asp:Label>
                </div>
                <asp:DropDownList ID="ddlIosmodel" CssClass="form-control col-md-6" runat="server" DataSourceID="SqlDataSource1" DataTextField="Model" DataValueField="Desc_Id" AutoPostBack="True"></asp:DropDownList><asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\project.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [Model], [Product_Id], [Desc_Id] FROM [Product_Description] WHERE ([Product_Id] = @Product_Id)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="6" Name="Product_Id" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
            <br />
                    ...
                    <ItemTemplate>
                        <div class="col-sm-6">
                            <div class="thumbnail">
                                ...
                                <br />
                                <asp:Button ID="btnAdd" runat="server" Text="wish List" CssClass="btn btn-success center-block BTNQTY" PostBackUrl="~/Cart.aspx" />
                                <br />
                            </div>
                        </div>
                    </ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\project.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [Product_Description] WHERE ([Desc_Id] = @Desc_Id) ORDER BY [Model]">
                <SelectParameters>
                    <asp:ControlParameter ControlID="ddlIosmodel" Name="Desc_Id" PropertyName="SelectedValue" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
        </main>
        <br />
